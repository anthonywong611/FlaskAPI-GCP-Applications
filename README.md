...
---
## Description
The goal of this project is to deploy a containerized Flask API on Google Cloud Platform, exposing it the internet for API users to make requests and submit information. 
